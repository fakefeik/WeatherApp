...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //[weather loadFromFile:self selector:@selector(selectorExample)];
    
    //self.window = [[[UIWindow alloc] initWithFrame: [[UIScreen mainScreen] bounds]] autorelease];
    //ForecastTimeViewController* ctrl = [[[ForecastTimeViewController alloc] initWithNibName:@"ForecastTimeView" bundle:[NSBundle mainBundle]] autorelease];
